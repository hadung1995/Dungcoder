package com.example.amd.dungintent3;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tenhinh=arrname.get(0);
        Collections.shuffle(arrname);

        int idhinh=getResources().getIdentifier(arrname.get(0),"drawable",getPackageName());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(requestCode==request_code && resultCode==RESULT_OK&&data!=null){
          String tenhinhnhan =data.getStringExtra("hinhne");
            ...
            if(tenhinh.equals(tenhinhnhan)){
                ...
                Toast.makeText(this, "Sai bet", Toast.LENGTH_SHORT).show();
            }
        }
